...
\textit{Note:} Since all of the tested datasets have high dimensionality, we use Principal Component Analysis (PCA) and the Uniform Manifold Approximation and Projection (UMAP)
...
\input{sections/results/optics}

\input{sections/results/spectral}

\input{sections/results/kmeans}

\input{sections/results/global_kmeans}

\input{sections/results/xmeans}

\input{sections/results/fuzzyCMean.tex}
