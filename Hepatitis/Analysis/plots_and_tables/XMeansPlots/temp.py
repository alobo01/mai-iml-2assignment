...
plot_3d_clusters_interactive("../../../Preprocessing/hepatitis_pca.csv", "xmeans_cluster_labels.csv",
                 "XMeans(max_clusters=20, tolerance=0.001, repeat_kmeans=1, use_kmeans_plus_plus=True)_0")
